...
トイレ/水流系FoleyをColour Bass素材として使い、NSColourMapでCmin7のグリッドへ寄せた例です。元音源はBigSoundBankのCC0サンプルを使用しています。

| Before | After |
| --- | --- |
| [Dry: toilet flush CC0 WAV](samples/toilet_flush_dry_cc0.wav) | [NSColourMap: COLOR 150 Tail + Cmin7 WAV](samples/toilet_flush_nscolourmap_color150_cmin7.wav) |
| <audio controls src="samples/toilet_flush_dry_cc0.wav"></audio> | <audio controls src="samples/toilet_flush_nscolourmap_color150_cmin7.wav"></audio> |
...
- Process: preset `10 COLOR 150 Tail`, MIDI Grid, held Cmin7 (`C Eb G Bb`), short 8 s excerpt.
