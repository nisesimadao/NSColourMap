...
inline constexpr std::array<PresetDef, 20> factory {{
    ...
    { "05 Grid Map Sweep",      0,  3,  0.90f, 0.80f,  0.f,  5.f, 0.3f, 0.45f, 0.1f, 0.2f, 120.f, 8000.f, 0,  9, 0.70f, 0.f },
    ...
    { "13 MIDI Map Texture",     1,  3,  0.95f, 0.85f,  0.f,  0.f, 0.4f, 0.45f, 0.1f, 0.2f, 120.f, 8000.f, 0,  7, 0.78f, 0.f },
    ...
    { "16 Whole Tone Map",       0,  3,  0.90f, 0.80f,  0.f,  3.f, 0.4f, 0.40f, 0.1f, 0.2f, 120.f, 8000.f, 0, 10, 0.68f, 0.f },
    ...
    { "19 Broken Map Tail",      1,  3,  1.40f, 0.85f,  0.f,  0.f, 0.5f, 0.35f, 0.2f, 0.0f, 130.f, 9000.f, 0,  9, 0.80f, 0.f },
